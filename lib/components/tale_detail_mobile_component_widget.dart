...
import 'tale_detail_mobile_component_model.dart';
export 'tale_detail_mobile_component_model.dart';

class TaleDetailMobileComponentWidget extends StatefulWidget {
  const TaleDetailMobileComponentWidget({
    super.key,
  ...
  @override
  State<TaleDetailMobileComponentWidget> createState() =>
      _TaleDetailMobileComponentWidgetState();
}

class _TaleDetailMobileComponentWidgetState
    extends State<TaleDetailMobileComponentWidget>
    with TickerProviderStateMixin {
  late TaleDetailMobileComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaleDetailMobileComponentModel());
                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            EdgeInsetsDirectional.fromSTEB(4.0, 10.0, 4.0, 0.0),
                        child: Text(
                          valueOrDefault<String>(
