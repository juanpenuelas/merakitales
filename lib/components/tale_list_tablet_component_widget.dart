...
export 'tale_list_tablet_component_model.dart';

class TaleListTabletComponentWidget extends StatefulWidget {
  const TaleListTabletComponentWidget({super.key});

  @override
  State<TaleListTabletComponentWidget> createState() =>
      _TaleListTabletComponentWidgetState();
}

class _TaleListTabletComponentWidgetState
    extends State<TaleListTabletComponentWidget> {
  late TaleListTabletComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaleListTabletComponentModel());
  }
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'octup6ez' /* Historias para soñar y aprende... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'jp542ya6' /* Porfavor selecciona un idioma */,
                                ),
                                icon: Icon(
