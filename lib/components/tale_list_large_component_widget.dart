...
import 'tale_list_large_component_model.dart';
export 'tale_list_large_component_model.dart';

class TaleListLargeComponentWidget extends StatefulWidget {
  const TaleListLargeComponentWidget({super.key});

  @override
  State<TaleListLargeComponentWidget> createState() =>
      _TaleListLargeComponentWidgetState();
}

class _TaleListLargeComponentWidgetState
    extends State<TaleListLargeComponentWidget> {
  late TaleListLargeComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaleListLargeComponentModel());
  }
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'knh5f1g0' /* Historias para soñar y aprende... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .labelMedium
                                      .override(
                            ...
                            Padding(
                              ...
                              child: FlutterFlowDropDown<String>(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'b1tyqkmo' /* Porfavor selecciona un idioma */,
                                ),
                                icon: Icon(
                            ...
                            Expanded(
                              child: Container(
                                ...
                                child: PagedListView<DocumentSnapshot<Object?>?,
                                  ...
                                  builderDelegate:
                                      PagedChildBuilderDelegate<TalesRecord>(
