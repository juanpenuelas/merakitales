...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: TailDetailWidget.routePath,
          asyncParams: {
            'taleParameter': getDoc(['tales'], TalesRecord.fromSnapshot),
          },
          builder: (context, params) => TailDetailWidget(
            taleParameter: params.getParam(
              'taleParameter',
              ParamType.Document,
            ),
          ),
